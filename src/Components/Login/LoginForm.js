      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <input
            ...
            className={`w-full py-3 px-4 bg-gray-50 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-400 ${validationErrors.email ? 'border-red-300 focus:ring-red-500' : 'border-gray-200'
              }`}
            required
          />
        ...
        <div className="relative">
          <input
            ...
            className={`w-full py-3 px-4 pr-12 bg-gray-50 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-400 ${validationErrors.password ? 'border-red-300 focus:ring-red-500' : 'border-gray-200'
              }`}
            required
          />
          <button
        ...
        <button
          type="submit"
          disabled={loading}
          className={`w-full bg-[#13008B] hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-xl transition-colors ${loading ? 'opacity-50 cursor-not-allowed' : ''
            }`}
        >
