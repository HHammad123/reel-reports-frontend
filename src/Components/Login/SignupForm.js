      ...
      <div className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div>
            <input
              ...
              className={`w-full py-3 px-4 bg-gray-50 border text-[1rem] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-400 ${
                validationErrors.name ? 'border-red-300 focus:ring-red-500' : 'border-gray-200'
              }`}
            />
        ...
        <div className="relative">
          <input
            ...
            className={`w-full py-3 px-4 pr-12 bg-gray-50 border text-[1rem] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-400 ${
        ...
        <button
          ...
          disabled={loading}
          className={`w-full bg-[#13008B] hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-lg transition-colors ${
            loading ? 'opacity-50 cursor-not-allowed' : ''
          }`}
        >
