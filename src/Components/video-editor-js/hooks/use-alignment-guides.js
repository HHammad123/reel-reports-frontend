...
export const useAlignmentGuides = ({ canvasWidth, canvasHeight, snapThreshold = 5, }) => {
     ...
     */
    const calculateGuidePositions = useCallback((draggedOverlay, allOverlays) => {
        const guides = [];
     ...
     */
    const findActiveGuides = useCallback((draggedOverlay, allOverlays) => {
     ...
     */
    const calculateSnapPosition = useCallback((draggedOverlay, allOverlays) => {
     ...
     */
    const updateGuides = useCallback((draggedOverlay, allOverlays) => {
        const activeGuides = findActiveGuides(draggedOverlay, allOverlays);
        setGuideState({
            isActive: true,
            guides: activeGuides,
