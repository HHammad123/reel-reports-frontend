 ...
 */
export const createStaticAudioAdaptor = (audioList, displayName = 'Stock Audio') => ({
    name: 'static-audio',
    displayName,
    ...
    search: async (params) => {
        ...
        if (params.query && params.query.trim()) {
            ...
            filtered = audioList.filter(audio => audio.title.toLowerCase().includes(query) ||
 ...
 */
export const getDefaultAudioAdaptors = () => {
