 ...
 */
export const createStaticTextAdaptor = (templates, displayName = 'Text Templates') => ({
    name: 'static-text',
    displayName,
 ...
 */
export const defaultTextAdaptor = createStaticTextAdaptor(Object.values(textOverlayTemplates), 'Default Text Styles');
/**
 * Helper function to get default text adaptors
 * This provides a consistent way to include default text templates
 */
export const getDefaultTextAdaptors = () => {
