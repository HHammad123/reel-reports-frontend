 ...
 */
export const TimelineItemFadeOverlays = React.memo(({ fadeIn = 0, fadeOut = 0, duration }) => {
    ...
    if (fadeIn === 0 && fadeOut === 0)
        return null;
    return (_jsxs(_Fragment, { children: [fadeIn > 0 && fadeInPercent > 0 && (_jsx("div", { className: "absolute left-0 top-0 bottom-0 pointer-events-none z-10", style: {
                    width: `${fadeInPercent}%`,
                }, children: _jsxs("svg", { className: "absolute inset-0 w-full h-full", preserveAspectRatio: "none", viewBox: "0 0 100 100", children: [_jsx("line", { x1: "0", y1: "100", x2: "100", y2: "0", stroke: `rgba(255, 255, 255, ${FADE_LINE_OPACITY})`, strokeWidth: FADE_LINE_STROKE_WIDTH, vectorEffect: "non-scaling-stroke" }), _jsx("polygon", { points: "0,0 100,0 0,100", fill: `rgba(0, 0, 0, ${FADE_OVERLAY_OPACITY})` })] }) })), fadeOut > 0 && fadeOutPercent > 0 && (_jsx("div", { className: "absolute right-0 top-0 bottom-0 pointer-events-none z-10", style: {
                    width: `${fadeOutPercent}%`,
                }, children: _jsxs("svg", { className: "absolute inset-0 w-full h-full", preserveAspectRatio: "none", viewBox: "0 0 100 100", children: [_jsx("line", { x1: "0", y1: "0", x2: "100", y2: "100", stroke: `rgba(255, 255, 255, ${FADE_LINE_OPACITY})`, strokeWidth: FADE_LINE_STROKE_WIDTH, vectorEffect: "non-scaling-stroke" }), _jsx("polygon", { points: "0,0 100,0 100,100", fill: `rgba(0, 0, 0, ${FADE_OVERLAY_OPACITY})` })] }) }))] }));
});
