...
export function useTimelineHistory(tracks, setTracks, onTracksChange, isDragging) {
    ...
    const undo = useCallback(() => {
        ...
        setHistory((prev) => {
            ...
            onTracksChange === null || onTracksChange === void 0 ? void 0 : onTracksChange(newPresent);
            return {
                past: newPast,
                present: newPresent,
