 ...
 */
export const useTimelineInteractions = (timelineRef) => {
    ...
    const isGhostMarkerVisibleRef = useRef(false);
        ...
        if (!isDragging && timelineRef.current) {
            ...
            throttleRef.current = requestAnimationFrame(() => {
                ...
                if (lastPositionRef.current === null || Math.abs(position - lastPositionRef.current) > 0.1) {
                    ...
                    const rootContainer = (_a = element === null || element === void 0 ? void 0 : element.parentElement) === null || _a === void 0 ? void 0 : _a.parentElement;
                    if (rootContainer) {
    ...
    const handleMouseLeave = useCallback(() => {
        ...
        if (timelineRef.current && isGhostMarkerVisibleRef.current) {
            // Find the root timeline container (parent of both tracks and overlay)
            const rootContainer = (_a = timelineRef.current.parentElement) === null || _a === void 0 ? void 0 : _a.parentElement;
            if (rootContainer) {
