...
// Use public URL for loading gif - ensures it works regardless of relative path issues
// If asset is in src/asset/, it should be accessible via /asset/loadingv2.gif when served
// Otherwise, this will fallback gracefully
const LoadingAnimationGif = "/asset/loadingv2.gif";
/**
 ...
 */
export const MediaOverlayPanel = ({ searchQuery, onSearchQueryChange, onSearch, items, isLoading, isLoadingSessionImages = false, isLoadingGeneratedBaseVideos = false, isLoadingGeneratedMediaImages = false, isDurationLoading = false, loadingItemKey = null, hasAdaptors, sourceResults, onItemClick, getThumbnailUrl, getItemKey, mediaType, searchPlaceholder, showSourceBadge = false, isEditMode, editComponent, isReplaceMode = false, onCancelReplace, enableTimelineDrag = false, sessionImages = [], sessionVideos = [], }) => {
