...
export const TemplateOverlayPanel = () => {
    ...
    return (_jsxs("div", { className: "flex flex-col p-2 h-full overflow-hidden", children: [sourceResults.length > 0 && (_jsx("div", { className: "shrink-0 mb-4", children: _jsx(UnifiedTabs, { sourceResults: sourceResults, activeTab: activeTab, onTabChange: setActiveTab }) })), _jsx("div", { className: "flex-1 overflow-y-auto scrollbar-hide", children: _jsx(TemplateGrid, { templates: filteredTemplates, isLoading: isLoading, hasAdaptors: templateAdaptors.length > 0, hasSearched: sourceResults.length > 0, activeTab: activeTab, sourceResults: sourceResults, onTemplateClick: handleSelectTemplate, error: error || undefined }) }), _jsx(ApplyTemplateDialog, { open: confirmDialogOpen, onOpenChange: setConfirmDialogOpen, selectedTemplate: selectedTemplate, onApplyTemplate: handleApplyTemplate })] }));
};
