...
const RenderControls = ({ state, handleRender, }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(Popover, { onOpenChange: () => setHasNewRender(false), children: [_jsx(PopoverTrigger, { asChild: true, children: _jsxs(Button, { variant: "ghost", size: "sm", className: "relative hover:bg-accent text-foreground", children: [_jsx(Bell, { className: "w-3.5 h-3.5" }), hasNewRender && (_jsx("span", { className: "absolute -top-0.5 -right-0.5 h-2 w-2 rounded-full bg-red-500" }))] }) }), _jsx(PopoverContent, { className: "w-60 bg-white p-3", children: _jsxs("div", { className: "space-y-1.5", children: [_jsx("h4", { className: "text-sm font-extralight", children: "Recent Renders" }), renders.length === 0 ? (_jsx("p", { className: "text-xs text-muted-foreground", children: "No renders yet" })) : (renders.map((render) => (_jsxs("div", { className: `flex items-center justify-between rounded-md border p-1.5 ${render.status === "error"
