 ...
 */
export const CropOverlay = ({ overlay, onCropChange }) => {
    ...
    const isUsingEffectiveDimensions = effectiveDimensions.width !== overlay.width ||
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { style: {
                    ...
                    height: barLength,
                    cursor: "ew-resize",
                }, onPointerDown: createDragHandler('left') }), _jsx("div", { style: {
                    ...dragBarStyle,
                    ...
                    height: barLength,
                    cursor: "ew-resize",
                }, onPointerDown: createDragHandler('right') }), _jsx("div", { style: {
                    ...dragBarStyle,
                    ...
                    height: lineWidth,
                    cursor: "ns-resize",
                }, onPointerDown: createDragHandler('top') }), _jsx("div", { style: {
                    ...dragBarStyle,
                    left: cropLeftPx + (cropRightPx - cropLeftPx) / 2 - barLength / 2 - offsetX,
