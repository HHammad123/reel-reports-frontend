 ...
 */
export const useAspectRatio = (initialRatio = "16:9", onRatioChange) => {
    ...
    const handleAspectRatioChange = useCallback((newRatio) => {
        ...
        onRatioChange === null || onRatioChange === void 0 ? void 0 : onRatioChange(newRatio);
    }, [onRatioChange]);
     ...
     */
    const updatePlayerDimensions = useCallback((containerWidth, containerHeight) => {
        let width, height;
