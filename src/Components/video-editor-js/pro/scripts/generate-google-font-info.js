...
async function generateFontInfo() {
    ...
    for (const font of top250) {
        try {
            ...
            const fontModule = (await font.load());
            ...
            const previewUrl = ((_a = fontInfo.url.match(/family=([^:]+):/)) === null || _a === void 0 ? void 0 : _a[1]) ||
            ...
            successCount++;
            console.log(`✅ Loaded ${fontInfo.fontFamily} (${successCount}/${top250.length})`);
        }
        catch (error) {
            errorCount++;
...
`;
    ...
    console.log(`✅ Created: ${serverFilePath} (${(serverFileContent.length / 1024 / 1024).toFixed(2)}MB)`);
...
`;
    ...
    console.log(`✅ Created: ${browserFilePath} (${(browserFileContent.length / 1024).toFixed(2)}KB)`);
    ...
    try {
        ...
        console.warn('⚠️  Prettier formatting failed, but files were generated successfully');
    }
