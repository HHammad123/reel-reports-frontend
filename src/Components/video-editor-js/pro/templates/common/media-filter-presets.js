 ...
 */
export const MEDIA_FILTER_PRESETS = [
    {
        id: "none",
        name: "None",
 ...
 */
export const parseFilterString = (filterString = "none") => {
...
export const getPresetById = (presetId) => {
    return (MEDIA_FILTER_PRESETS.find((preset) => preset.id === presetId) ||
        MEDIA_FILTER_PRESETS[0]); // Default to "none" preset
};
