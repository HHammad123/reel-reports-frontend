 ...
 */
export const generateClipPath = (x = 0, y = 0, width = 100, height = 100) => {
...
export const getEffectiveCropDimensions = (overlay) => {
    ...
    const cropX = (_a = overlay.styles.cropX) !== null && _a !== void 0 ? _a : 0;
    const cropY = (_b = overlay.styles.cropY) !== null && _b !== void 0 ? _b : 0;
    const cropWidth = (_c = overlay.styles.cropWidth) !== null && _c !== void 0 ? _c : 100;
    const cropHeight = (_d = overlay.styles.cropHeight) !== null && _d !== void 0 ? _d : 100;
 ...
 */
export const hasActiveCrop = (overlay) => {
    if (!overlay.styles)
        return false;
