...
import { addMediaItem } from "./indexdb";
...
export const uploadMediaFile = async (file) => {
    try {
        ...
        try {
            ...
            // Create media item for IndexedDB with cleaned server path
            const mediaItem = {
                id: serverResult.id,
                userId,
                name: file.name,
                type: fileType,
                serverPath: cleanServerPath, // Store cleaned path without prefix
 ...
 */
async function uploadToServer(file, userId) {
 ...
 */
async function uploadAsBlob(file, userId, fileType, thumbnail, duration) {
 ...
 */
export const deleteMediaFile = async (userId, filePath) => {
    try {
