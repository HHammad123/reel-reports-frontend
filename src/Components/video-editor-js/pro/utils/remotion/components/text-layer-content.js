...
export const TextLayerContent = ({ overlay, fontInfos, }) => {
    ...
    const getFontFamily = () => {
        ...
        if (fontValue === null || fontValue === void 0 ? void 0 : fontValue.startsWith('font-')) {
            switch (fontValue) {
                case "font-sans":
                    return "Inter";
                case "font-serif":
    ...
    const fontSize = useMemo(() => {
        ...
        const extractPadding = (paddingStr) => {
            ...
            const values = paddingStr.split(' ').map(v => {
                if (v.endsWith('px'))
                    return parseInt(v);
                if (v.endsWith('em'))
                    return parseInt(v) * 16; // Rough conversion
                return 0;
            });
            if (values.length === 1) {
        ...
        const maxSize = Math.min(overlay.height * 0.8, // Much more generous - 80% of height
    ...
    const enterKey = (_e = overlay.styles.animation) === null || _e === void 0 ? void 0 : _e.enter;
    ...
    return (_jsx("div", { style: containerStyle, children: _jsx("div", { style: textStyle, children: renderedContent }) }));
};
